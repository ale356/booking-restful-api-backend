...
import { EmailsController } from '../../../controllers/api/emails-controller.js'
...
// Provide req.email to the route if :id is present in the route path.
router.param('id', (req, res, next, id) => controller.loadEmail(req, res, next, id))
